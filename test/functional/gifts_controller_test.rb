...
class GiftsControllerTest < ActionController::TestCase
  ...
  test "should create gift" do
    assert_difference('Gift.count') do
      post :create, gift: { gift_id: @gift.gift_id, gift_name: @gift.gift_name, gift_url: @gift.gift_url, project_id: @gift.project_id }
    end
  ...
  test "should update gift" do
    put :update, id: @gift, gift: { gift_id: @gift.gift_id, gift_name: @gift.gift_name, gift_url: @gift.gift_url, project_id: @gift.project_id }
    assert_redirected_to gift_path(assigns(:gift))
  end
